...
| [`local-mac-native/`](local-mac-native/README.md) | `scripts/run/up.sh` | `cgn_infer` → `cgn-infer serve`     | Fully first-party stack. No Python — the engine is a workspace Rust binary on a local GGUF. |
